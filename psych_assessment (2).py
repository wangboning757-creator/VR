...
def page_assessment():
    ...
    # Scene banner — semi-transparent so VR bg shows through
    st.markdown(f"""
    <div style="background:rgba(4,14,36,0.55);backdrop-filter:blur(6px);
                ...
                box-shadow:0 0 40px rgba(26,122,212,0.3),inset 0 0 60px rgba(0,0,0,0.2);">
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:0.7rem;">
        <span style="font-size:2.2rem;">{SCENE['emoji']}</span>
        <div>
          <div style="color:#4dc3ff;font-size:0.72rem;letter-spacing:0.12em;font-family:'Share Tech Mono',monospace;
                      text-shadow:0 0 10px #4dc3ff;">
            ACTIVE SCENARIO
          </div>
          <div style="color:#ffffff;font-size:1.1rem;font-weight:700;text-shadow:0 0 12px rgba(77,195,255,0.6);">{SCENE['label']}</div>
        </div>
      </div>
      <p style="color:#c8e8ff;font-size:0.95rem;line-height:1.65;margin:0;
                border-left:2px solid #4dc3ff;padding-left:1rem;font-style:italic;
    ...
    # Floating notification badges — VR style
    st.markdown("""
    <div style="position:relative;background:rgba(0,0,0,0.35);backdrop-filter:blur(4px);
                border:1px solid rgba(77,195,255,0.2);
                border-radius:10px;padding:0.8rem 1.2rem;margin-bottom:1rem;overflow:hidden;">
      <div style="font-family:'Share Tech Mono',monospace;font-size:0.68rem;color:#4dc3ff;
                  letter-spacing:0.1em;margin-bottom:0.5rem;">── INCOMING INTERRUPTIONS ──</div>
      <div style="display:flex;gap:0.7rem;flex-wrap:wrap;">
        <div style="background:rgba(30,80,200,0.45);border:1px solid #4a8ae8;border-radius:8px;
                    padding:0.35rem 0.9rem;font-size:0.78rem;color:#aad0ff;font-family:'Share Tech Mono',monospace;
                    box-shadow:0 0 10px rgba(74,138,232,0.4);">
          💬 New message (3)
        </div>
        <div style="background:rgba(200,100,0,0.4);border:1px solid #e8a020;border-radius:8px;
                    padding:0.35rem 0.9rem;font-size:0.78rem;color:#ffd080;font-family:'Share Tech Mono',monospace;
                    box-shadow:0 0 10px rgba(232,160,32,0.4);">
          🔔 Calendar alert
        </div>
        <div style="background:rgba(0,140,60,0.4);border:1px solid #20c060;border-radius:8px;
                    padding:0.35rem 0.9rem;font-size:0.78rem;color:#80ffb0;font-family:'Share Tech Mono',monospace;
                    box-shadow:0 0 10px rgba(32,192,96,0.4);">
          📧 Email from manager
        </div>
        <div style="background:rgba(140,0,180,0.4);border:1px solid #c040e0;border-radius:8px;
                    padding:0.35rem 0.9rem;font-size:0.78rem;color:#e0a0ff;font-family:'Share Tech Mono',monospace;
                    box-shadow:0 0 10px rgba(192,64,224,0.4);">
          👥 Team mention
        </div>
      </div>
      <div style="position:absolute;top:0.6rem;right:0.9rem;font-family:'Share Tech Mono',monospace;
                  font-size:0.75rem;color:#ff5030;text-shadow:0 0 8px #ff5030;">⏱ 04:32 remaining</div>
    </div>
    """, unsafe_allow_html=True)

    # Question box — semi-transparent glass
    st.markdown(f"""
    <div style="background:rgba(0,0,0,0.45);backdrop-filter:blur(8px);
                border:1px solid rgba(77,195,255,0.3);border-radius:12px;
                padding:1.2rem 1.5rem;margin-bottom:0.8rem;
                box-shadow:0 0 30px rgba(0,0,0,0.5);">
      <h3 style="color:#ffffff;font-size:1.15rem;font-weight:700;margin:0 0 0.2rem;
                 text-shadow:0 0 16px rgba(77,195,255,0.7);">
        💬 {QUESTION['text']}
      </h3>
    </div>
    """, unsafe_allow_html=True)
