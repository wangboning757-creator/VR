...
ORIGINAL_SCENE_IMG = img_to_b64(pathlib.Path(__file__).parent / "wide_interior_pov_scene_looks_like_a_realistic_cg.png")
ADAPTED_SCENE_IMG = img_to_b64(pathlib.Path(__file__).parent / "wide_cozy_sunlit_interior_scene_viewed_in_a_vr_ro.png")
...
def page_adjustment():
    ...
    with col_before:
        ...
        <div style="background:rgba(40,10,10,0.5);border:1px solid #6a1a1a;border-radius:12px;padding:1.2rem;">
          ...
          <img src="data:image/png;base64,{ORIGINAL_SCENE_IMG}" style="width:100%;border-radius:10px;margin-bottom:0.8rem;" />
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_after:
        ...
        <div style="background:rgba(10,30,10,0.5);border:1px solid #1a6a2a;border-radius:12px;padding:1.2rem;
          ...
          <img src="data:image/png;base64,{ADAPTED_SCENE_IMG}" style="width:100%;border-radius:10px;margin-bottom:0.8rem;" />
        </div>
        """, unsafe_allow_html=True)
