...
def page_report():
    ...
    st.markdown(f"""
    <div style="background:rgba(6,18,44,0.92);border:1px solid #1a4a8a;border-radius:14px;padding:1.4rem 1.8rem;margin-bottom:1.2rem;">
      <div style="color:#4dc3ff;font-size:0.74rem;letter-spacing:0.12em;font-family:'Share Tech Mono',monospace;margin-bottom:1rem;">
      ...
      <div style="display:flex;gap:1.2rem;flex-wrap:wrap;">
        <div style="background:rgba(80,15,15,0.35);border:1px solid #5a1a1a;border-radius:10px;padding:1rem;flex:1;min-width:280px;">
          ...
          {before_rows}
          <div style="margin-top:0.8rem;text-align:center;color:#ff7043;font-size:1.4rem;font-family:'Share Tech Mono',monospace;">{overall_before}<span style="font-size:0.85rem;color:#8a3a2a;">/100</span></div>
        </div>
        <div style="background:rgba(10,40,20,0.45);border:1px solid #1a6a2a;border-radius:10px;padding:1rem;box-shadow:0 0 16px rgba(0,230,118,0.1);flex:1;min-width:280px;">
          <div style="color:#00e676;font-size:0.7rem;letter-spacing:0.1em;font-family:'Share Tech Mono',monospace;margin-bottom:0.8rem;">
            AFTER ADJUSTMENT ✦
          </div>
          {after_rows}
          <div style="margin-top:0.8rem;text-align:center;color:#00e676;font-size:1.4rem;font-family:'Share Tech Mono',monospace;">{overall}<span style="font-size:0.85rem;color:#2a7a4a;">/100</span>
