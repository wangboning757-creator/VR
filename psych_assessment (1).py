...
if BG_PATH.exists():
    ...
    BG_CSS = "radial-gradient(ellipse at 20% 10%, #0a2040 0%, #020b1a 60%)"
...
[data-testid="stAppViewContainer"] {{
    background: {BG_CSS} center/cover no-repeat fixed !important;
}}
...
def page_assessment():
    ...
    # Scene banner
    st.markdown(f"""
    <div style="background:linear-gradient(135deg,rgba(6,20,50,0.95),rgba(12,38,80,0.9));
      ...
      <div style="display:flex;align-items:center;gap:1rem;margin-bottom:0.7rem;">
        ...
        <div>
          ...
          <div style="color:#e8f4ff;font-size:1.1rem;font-weight:700;">{SCENE['label']}</div>
        </div>
      </div>
      <p style="color:#8ab8d8;font-size:0.95rem;line-height:1.65;margin:0;
                border-left:2px solid #1a5a9a;padding-left:1rem;font-style:italic;">
        "{SCENE['desc']}"
      </p>
    </div>
    """, unsafe_allow_html=True)

    # Notification animation overlay (decorative)
    st.markdown("""
    <div style="position:relative;background:rgba(4,12,30,0.7);border:1px solid #0d2a4a;
                border-radius:10px;padding:1rem 1.2rem;margin-bottom:1.2rem;overflow:hidden;">
      <div style="display:flex;gap:0.8rem;flex-wrap:wrap;opacity:0.75;">
        <div style="background:rgba(30,80,160,0.4);border:1px solid #2a6aaa;border-radius:8px;
                    padding:0.3rem 0.8rem;font-size:0.75rem;color:#7aaad4;font-family:'Share Tech Mono',monospace;">
          💬 New message (3)
        </div>
        <div style="background:rgba(180,80,20,0.3);border:1px solid #d48a1a;border-radius:8px;
                    padding:0.3rem 0.8rem;font-size:0.75rem;color:#d4aa6a;font-family:'Share Tech Mono',monospace;">
          🔔 Calendar alert
        </div>
        <div style="background:rgba(20,120,60,0.3);border:1px solid #1aaa5a;border-radius:8px;
                    padding:0.3rem 0.8rem;font-size:0.75rem;color:#6ad4a0;font-family:'Share Tech Mono',monospace;">
          📧 Email from manager
        </div>
        <div style="background:rgba(120,30,120,0.3);border:1px solid #9a3a9a;border-radius:8px;
                    padding:0.3rem 0.8rem;font-size:0.75rem;color:#cc8acc;font-family:'Share Tech Mono',monospace;">
          👥 Team mention
        </div>
      </div>
      <div style="position:absolute;top:0.5rem;right:0.8rem;font-family:'Share Tech Mono',monospace;
                  font-size:0.72rem;color:#ff7043;">⏱ 04:32 remaining</div>
    </div>
    """, unsafe_allow_html=True)

    # Question
    st.markdown(f"""
    <h3 style="color:#e8f4ff;font-size:1.15rem;font-weight:700;margin-bottom:0.8rem;">
      💬 {QUESTION['text']}
    </h3>
    """, unsafe_allow_html=True)
